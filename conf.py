...
latex_documents = [
    (master_doc, 'book.tex', u'TCP Congestion Control: A Systems Approach',
     u'Peterson, Brakmo and Davie ', 'manual', True),
]
...
texinfo_documents = [
    (master_doc, 'TCP Congestion Control', u'Software-Defined Networks',
     author, 'Peterson, Brakmo, and Davie', 'A Systems Approach',
     'Miscellaneous'),
]
...
GA_INVOKE_JS = """
  ...
  gtag('config', 'G-SQ9EK50CDR');
"""

def setup(app):

    app.add_js_file('https://www.googletagmanager.com/gtag/js?id=G-SQ9EK50CDR', loading_method="async")
